...
class PartNormalDatasetLoader(Dataset):
    def __init__(self, root='./dataset/shapenetcore_partanno_segmentation_benchmark_v0_normal', npoints=1024,
...
if __name__ == '__main__':
    ...
    DataLoader = torch.utils.data.DataLoader(data, batch_size=50, shuffle=False)
